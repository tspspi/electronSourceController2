...
class ElectronGunControl:
    ...
    def __str__(self):
        ...
        s += f"\t\tCathode:\t\t{state['hv_voltage'][1]} V, {state['hv_current'][1]} uA (mode {state['hv_modes'][1]})\n"
        s += f"\t\tWhenelt cylinder:\t{state['hv_voltage'][0]} V, {state['hv_current'][0]} uA (mode {state['hv_modes'][0]})\n"
        s += f"\t\tFocus voltage:\t{state['hv_voltage'][2]} V, {state['hv_current'][2]} uA (mode {state['hv_modes'][2]})\n"
        s += f"\t\tAux supply:\t\t{state['hv_voltage'][3]} V, {state['hv_current'][3]} uA (mode {state['hv_modes'][3]})\n"
