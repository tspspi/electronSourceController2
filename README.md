...
| Disable all voltages (PSU and filament) | $$$OFF<LF>             | Disabled all voltages including the filament supply                                                          | implemented                      |
...
| Set filament current                    | $$$SETFILA[n]<LF>      | Sets filament current (if supported)                                                                         |                                  |
