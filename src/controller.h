...
#define __is_included__d81475f8_df0f_11eb_ba7e_b499badf00a1 1
    ...
    #define CONTROLLER_RAMP_TARGETV__FOC 1808
#endif
    ...
    #define CONTROLLER_RAMP_VOLTAGE_CURRENTLIMIT 5
#endif

#ifndef CONTROLLER_RAMP_VOLTAGE_STEPDURATIONMILLIS
    #define CONTROLLER_RAMP_VOLTAGE_STEPDURATIONMILLIS 300000
#endif
    ...
    #define CONTROLLER_RAMP_FILCURRENT_STEPDURATIONMILLIS 3000000
#endif
