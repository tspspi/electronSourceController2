...
#define SERIAL_UART2_ENABLE 0
    ...
    #define CONTROLLER_RAMP_VOLTAGE_STEPDURATIONMILLIS 900000
#endif
    ...
    #define CONTROLLER_RAMP_FILCURRENT_STEPSIZE 5
#endif
